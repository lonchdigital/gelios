...
Route::group([
    ...
    //    Route::get('/logout', [AdminAuthController::class, 'adminLogout'])->name('adminLogout');
        ...
        'middleware' => [
            ...
            Route::get('/lead-form-apps', [PageController::class, 'leadAppsIndex'])->name('admin.lead-apps.index');

            Route::get('/lead-form-settings', [PageController::class, 'leadAppsSettings'])->name('admin.lead-settings.index');
            Route::get('/language-settings', [PageController::class, 'languageSettings'])->name('admin.language-settings.index');
        });
