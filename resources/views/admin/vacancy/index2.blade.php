                ...
                <div class="card mb-30">
                    <div class="card-body pb-0">
                        <div class="d-flex justify-content-between align-items-center mb-20">
                            <h6 class="card-title mb-0">{{ __('admin.vacancy') }}</h6>
                            ...
                            <table class="table table-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            <a href="{{ route('admin.vacancies.edit-main-seo') }}" class="mr-2"><i class="fa fa-edit text-info font-18"></i></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            <a href="{{ route('admin.vacancy-apps.index') }}" class="mr-2"><i class="fa fa-edit text-info font-18"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
