                ...
                <div class="card mb-30">
                    <div class="card-body pb-0">
                        <div class="d-flex justify-content-between align-items-center mb-20">
                            <h6 class="card-title mb-0">{{ __('admin.surgery') }}</h6>
                        ...
                        <div class="table-responsive art-cars-list">
                            <table class="table table-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            {{ __('admin.promotion_seo_page') }}
                                        </td>
                                        <td style="text-align: right">
                                            <a href="{{ route('admin.promotions.edit-main-seo') }}" class="mr-2"><i class="fa fa-edit text-info font-18"></i></a>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>
                                            {{ __('admin.one_promotion_seo') }}
                                        </td>
                                        <td style="text-align: right">
                                            <a href="{{ route('admin.promotions.edit-one-page-seo') }}" class="mr-2"><i class="fa fa-edit text-info font-18"></i></a>
                                        </td>
                                    </tr>
