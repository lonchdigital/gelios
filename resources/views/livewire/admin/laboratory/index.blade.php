        ...
        <div class="card mb-30">
            <div class="card-body pb-0">
                <div class="d-flex justify-content-between align-items-center mb-20">
                    <h5 class="card-title mb-0">Список блоків сторінки Лабораторії</h5>
                        ...
                        @foreach($this->laboratories as $laboratory)
                            <tr>
                                ...
                                <td style="text-align: right">
                                    ...
                                    <a wire:click="deleteItem('{{ $laboratory->id }}', 'user')" style="cursor: pointer"><i class="fa fa-trash text-danger font-18"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
