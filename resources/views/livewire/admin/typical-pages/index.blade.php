                        ...
                        <div class="card mb-30">
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-20">
                                    <h6 class=" mb-0">{{ trans('admin.typical_pages_list') }}</h6>
                                        ...
                                        @foreach($pages as $page)
                                            <tr>
                                                ...
                                                <td style="text-align: right">
                                                    <a href="{{ route('typical.pages.edit', $page) }}" class="mr-2"><i class="fa fa-edit text-info font-18"></i></a>
                                                    ...
                                                    <div class="md-modal md-effect-1" id="modal-{{ $page->id }}">
                                                        <div class="md-content">
                                                            ...
                                                            <div class="d-flex art-modal-buttons">
                                                                ...
                                                                <button wire:click="removeTypicalPageFromDB('{{ $page->id }}')" class="btn btn-danger d-block">{{ trans('admin.delete') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
