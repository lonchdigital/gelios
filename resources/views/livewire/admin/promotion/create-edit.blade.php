                    ...
                    <section class="mb-50">
                        <h6 class="card-title">
                            @if (!empty($this->promotion->id))
                                {{ __('admin.edit_promotion') }}
                            @else
                                {{ __('admin.create_promotion') }}
                            @endif
                        </h6>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-12">
                                                                ...
                                                                @if($errors->has('uaPrice'))
                                                                    <div class="mt-1 text-danger ajaxError">{{ $errors->first('uaPrice') }}</div>
                                                                @elseif($errors->has('ruPrice'))
                                                                    <div class="mt-1 text-danger ajaxError">{{ $errors->first('ruPrice') }}</div>
                                                                @elseif($errors->has('enPrice'))
                                                                    <div class="mt-1 text-danger ajaxError">{{ $errors->first('enPrice') }}</div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            @elseif(!empty($this->promotion->image))
                                                                <img src="{{ $this->promotion->imageUrl }}"
                                                                    width="60">
                                                            @endif
                                                        </div>
                                                    </div>
