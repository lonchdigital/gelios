    ...
    <main class="main">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-lg-4 position-static">
                                                                <div class="directions-item">
                                                                    <div class="content">
                                                                        <a href="##" class="link">
                                                                            <span>Функціональна діагностика</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-lg-4 position-static">
                                                                <div class="directions-item">
                                                                    <div class="content">
                                                                        <a href="##" class="link">
                                                                            <span>Хірургія в гінекології</span>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <div class="push-menu--lvl">
                                                                            <div class="category-directions">
                                                                                <div class="category-directions--list">
                                                                                    <div class="row">
                                                                                        <div
                                                                                            class="col-12 col-lg-4 position-static">
                                                                                            <div class="directions-item">
                                                                                                <div class="content">
                                                                                                    <a href="##"
                                                                                                        class="link">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="directions-item">
                                                                                                <div
                                                                                                    class="content item has-dropdown">
                                                                                                    <a href="##"
                                                                                                        class="link">
                                                                                                        <span>Нейрохірургія</span>
                                                                                                        <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="push-menu--lvl lvl-end">
                                                                                                        <div
                                                                                                            class="category-directions">
                                                                                                            <div
                                                                                                                class="category-directions--list">
                                                                                                                <div
                                                                                                                    class="row">
                                                                                                                    <div
                                                                                                                        class="col-12 col-lg-4 position-static">
                                                            ...
                                                            <div class="col-12 col-lg-4 position-static">
                                                                <div class="directions-item">
                                                                    <div class="content item has-dropdown">
                                                                        <a href="##" class="link">
                                                                            <span>Реконструктивна хірургія</span>
                                                                            <div class="i-link"></div>
                                                                        </a>
                                                                        <div class="push-menu--lvl">
                                                                            <div class="category-directions">
        ...
        <section class="offices mb-24">
            <div class="container overflow-hidden">
                <div class="row mb-8">
                    <div class="col d-flex align-items-center justify-content-between">
                        <div class="h2 font-m font-weight-bolder">Наші філії</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
