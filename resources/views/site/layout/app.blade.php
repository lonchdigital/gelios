...
<head>
  ...
  */
    ...
    @if (app()->environment('production'))
        ...
        <script type="text/javascript">
            (function(d, w, s) {
                var widgetHash = 'U1zn5ePsm2agfTWoWhpe', bch = d.createElement(s); bch.type = 'text/javascript'; bch.async = true;
    ...
    fbq('init', '2665910216958947');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=2665910216958947&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
</head>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5W2T73G"
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-5W2T73G');</script>
