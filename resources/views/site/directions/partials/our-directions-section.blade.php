                        ...
                        <div class="push-menu">
                            <div class="push-menu--nav">
                                <div class="nav-toggle">
                                    <div class="btn-nav-back btn-nav-direction btn font-weight-bold ml-auto mb-6"><span>{{ trans('web.back') }}</span><span class="icon"></span></div>
                                </div>
                                                    ...
                                                    @foreach ($allDirections as $oneDirection)
                                                        <div class="col-12 col-lg-4 position-static">
                                                            @if( $oneDirection['children'] )
                                                                <div class="directions-item">
                                                                    <div class="content item has-dropdown">
                                                                        <a href="{{ $oneDirection['full_path'] }}" class="link">
                                                            ...
                                                            @else
                                                                <div class="directions-item">
                                                                    <div class="content">
                                                                        <a class="link" href="{{ $oneDirection['full_path'] }}">
                                                                            {{ $oneDirection['name'] }}
                                                                        </a>
                                                                    </div>
                                                                </div>
