...
return [
    ...
    'after'                => 'Поле :attribute має містити дату не раніше ніж :date.',
    ...
    'before'               => 'Поле :attribute має містити дату не пізніше ніж :date.',
    'before_or_equal'      => 'Поле :attribute має містити дату не пізніше ніж, або дорівнюватися :date.',
    'between'              => [
    ...
    'unique_id'            => 'Вказане значення вже існує для наступних ID: :attribute',
    ...
    'feedback' => [
        'phone' => 'Номер телефону повинен починатися з +380 або 380.',
        'phone.min' => 'Поле :attribute повинне бути не менше :min.',
        'phone.max' => 'Поле :attribute має бути не більше :max.',
        'name.required' => 'Поле ім\'я є обов\'язковим для заповнення.'
    ],
    'phone' => 'номер тедефону',
    'doctor' => 'лікар',
    'name' => 'ім\'я',
    'clinic' => 'клінка',
];
