...
return [
    ...
    'password_string'      => [
        'Значение поля :attribute должно быть строкой.',
    ],
    ...
    'password_regex' => [
        "Значение поля :attribute должно:",
        "8 символов или более с хотя бы одной прописной буквой",
        "Нижний регистр",
        "Числовая цифра",
    ...
    'feedback' => [
        'phone' => 'Номер телефона должен начинаться с +380 или 380.',
        'phone.min' => 'Поле :attribute должно быть не менее :min символов.',
        'phone.max' => 'Поле :attribute должно быть не более :max символов.',
